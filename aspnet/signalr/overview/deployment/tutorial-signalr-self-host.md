...
- Funkcja SignalR jest ma zostać dodany do istniejącego wystąpienia usług aplikacji, która działa w usługę Windows, rola procesu roboczego platformy Azure lub inny proces.
