...
title: ASP.NET Identity funkcje & API — ASP.NET 4. x
...
ms.locfileid: "78584316"
---
# <a name="aspnet-4x-identity-features--api"></a>Funkcje tożsamości ASP.NET 4. x & interfejs API
