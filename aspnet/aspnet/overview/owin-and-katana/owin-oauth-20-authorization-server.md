...
- `Config.SuppressDefaultHostAuthentication` Pomija domyślne hosta uwierzytelniony podmiot zabezpieczeń z poziomu aplikacji, dlatego wszystkie żądania będą anonimowy po tym wywołaniu.
