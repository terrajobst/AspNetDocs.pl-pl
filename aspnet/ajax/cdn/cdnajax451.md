...
title: ASP.NET Web Forms i AJAX 4.5.1 | Microsoft Docs
...
ms.locfileid: "78563358"
---
# <a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="7c887-102">ASP.NET Web Forms i AJAX 4.5.1</span><span class="sxs-lookup"><span data-stu-id="7c887-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>

<span data-ttu-id="7c887-103">Następujące pliki są hostowane w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="7c887-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="7c887-104">Uwaga: skrypty globalizacji, takie jak fr-FR. js, można znaleźć w następującym folderze:</span><span class="sxs-lookup"><span data-stu-id="7c887-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
