...
title: ASP.NET Web Forms i AJAX 4 | Microsoft Docs
...
ms.locfileid: "78563351"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="49bb3-102">ASP.NET Web Forms i AJAX 4</span><span class="sxs-lookup"><span data-stu-id="49bb3-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="49bb3-103">Następujące pliki są hostowane w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="49bb3-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="49bb3-104">Uwaga: skrypty globalizacji, takie jak fr-FR. js, można znaleźć w następującym folderze:</span><span class="sxs-lookup"><span data-stu-id="49bb3-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
