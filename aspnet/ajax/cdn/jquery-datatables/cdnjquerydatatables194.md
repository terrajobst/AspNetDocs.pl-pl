...
ms.locfileid: "78563211"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="8dd45-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="8dd45-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="8dd45-103">Następujące pliki wtyczek DataTables jQuery są hostowane w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="8dd45-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
