...
#### <a name="jquery-version-341"></a>Wersja jQuery 3.4.1
...
- [Sprawdź poprawność 1.19.1 jQuery](jquery-validate/cdnjqueryvalidate1191.md "jQuery 1.19.1 sprawdzania poprawności")
...
Następujące wersje programu [odpowiadać](https://github.com/scottjehl/Respond "odpowiadać") znajdują się w sieci CDN:
