...
ms.locfileid: "57067817"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="59e4e-102">jQuery Templates Beta 1</span><span class="sxs-lookup"><span data-stu-id="59e4e-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="59e4e-103">Wtyczki szablonów jQuery zawiera następujące pliki:</span><span class="sxs-lookup"><span data-stu-id="59e4e-103">The jQuery Templates plugin includes the following files:</span></span>
