...
title: 1\.14.0 walidacji jQuery | Microsoft Docs
...
ms.locfileid: "78585114"
---
# <a name="jquery-validation-1140"></a><span data-ttu-id="51972-102">jQuery Validation 1.14.0</span><span class="sxs-lookup"><span data-stu-id="51972-102">jQuery Validation 1.14.0</span></span>

<span data-ttu-id="51972-103">Następujące pliki są hostowane w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="51972-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="51972-104">Pliki lokalizacji w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js gdzie # # to kod Loc.</span><span class="sxs-lookup"><span data-stu-id="51972-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js where ## is the loc code.</span></span>
