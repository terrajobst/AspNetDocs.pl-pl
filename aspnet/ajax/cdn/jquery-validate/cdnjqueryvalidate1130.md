...
ms.locfileid: "59379329"
---
# <a name="jquery-validation-1130"></a><span data-ttu-id="49205-102">jQuery Validation 1.13.0</span><span class="sxs-lookup"><span data-stu-id="49205-102">jQuery Validation 1.13.0</span></span>

<span data-ttu-id="49205-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="49205-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="49205-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js gdzie ## znajduje się kod lokalizacja.</span><span class="sxs-lookup"><span data-stu-id="49205-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js where ## is the loc code.</span></span>
