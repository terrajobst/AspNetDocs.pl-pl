...
title: jquery.Validate wersja 1.8.1 | Dokumentacja firmy Microsoft
...
ms.locfileid: "57078519"
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="2916e-102">jquery.validate wersja 1.8.1</span><span class="sxs-lookup"><span data-stu-id="2916e-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="2916e-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="2916e-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="2916e-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js gdzie ## znajduje się kod lokalizacja.</span><span class="sxs-lookup"><span data-stu-id="2916e-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
