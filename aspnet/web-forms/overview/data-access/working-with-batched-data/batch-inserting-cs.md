...
[![Ton interfejsu wstawiania wsadowego](batch-inserting-cs/_static/image2.png)](batch-inserting-cs/_static/image1.png)
...
[![Dprzeciąganie panelu z przybornika w Projektancie](batch-inserting-cs/_static/image5.png)](batch-inserting-cs/_static/image4.png)

**Rysunek 2**: Przeciąganie panelu z przybornika do projektanta ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](batch-inserting-cs/_static/image6.png))
...
[![Dpasek danych zwróciło klasy ProductsBLL s GetProducts metoda](batch-inserting-cs/_static/image8.png)](batch-inserting-cs/_static/image7.png)
...
[![Set list rozwijanych w aktualizacji, WSTAWIANIA i usuwania karty (Brak)](batch-inserting-cs/_static/image11.png)](batch-inserting-cs/_static/image10.png)
...
[![TZawiera on GridView produktów i oferuje sortowania i stronicowania możliwości](batch-inserting-cs/_static/image14.png)](batch-inserting-cs/_static/image13.png)

**Rysunek 5**: Kontrolki GridView zawiera listę produktów i oferuje sortowania i stronicowania możliwości ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](batch-inserting-cs/_static/image15.png))
...
[![TWstawianie interfejsu składa się on z cztery kolumny, tabeli Wiersz 7](batch-inserting-cs/_static/image17.png)](batch-inserting-cs/_static/image16.png)

**Rysunek 6**: Wstawianie interfejsu składa się z cztery kolumny, tabeli Wiersz 7 ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](batch-inserting-cs/_static/image18.png))
...
[![Configuruj ObjectDataSource na korzystanie z klasy SuppliersBLL s GetSuppliers metoda](batch-inserting-cs/_static/image20.png)](batch-inserting-cs/_static/image19.png)
...
[![Dpasek danych NazwaFirmy i identyfikator użycia jako wartość](batch-inserting-cs/_static/image23.png)](batch-inserting-cs/_static/image22.png)
...
[![TZawiera on wiersz nagłówka teraz dostawców i kategorii kontrolek DROPDOWNLIST](batch-inserting-cs/_static/image26.png)](batch-inserting-cs/_static/image25.png)
...
[![TADAM Wstawianie interfejsu teraz zawiera pola tekstowe nazw produktów i ceny](batch-inserting-cs/_static/image29.png)](batch-inserting-cs/_static/image28.png)
...
[![Pkoronki StatusLabel kontroli nad dwa formanty panelu](batch-inserting-cs/_static/image32.png)](batch-inserting-cs/_static/image31.png)
...
[![A Nazwa produktu jest wymagany po wprowadzeniu cena jednostkowa](batch-inserting-cs/_static/image38.png)](batch-inserting-cs/_static/image37.png)
...
[![Ttrzy nowe Veggies dodano s Mayumi dostawcy](batch-inserting-cs/_static/image41.png)](batch-inserting-cs/_static/image40.png)
...
[![TZnajduje się on nowe produkty na ostatniej stronie widoku GridView](batch-inserting-cs/_static/image44.png)](batch-inserting-cs/_static/image43.png)
