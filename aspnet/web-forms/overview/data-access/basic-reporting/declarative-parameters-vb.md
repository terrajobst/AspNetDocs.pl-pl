...
[![Add ObjectDataSource do strony](declarative-parameters-vb/_static/image2.png)](declarative-parameters-vb/_static/image1.png)
...
[![SWybiera klasę ProductsBLL](declarative-parameters-vb/_static/image5.png)](declarative-parameters-vb/_static/image4.png)
...
[![Cbierz metodę GetProductByProductID(productID)](declarative-parameters-vb/_static/image8.png)](declarative-parameters-vb/_static/image7.png)
...
[![A Zakodowanych parametrów z 5 zostanie użyta wartość dla elementu productID parametr](declarative-parameters-vb/_static/image11.png)](declarative-parameters-vb/_static/image10.png)
...
[![IWyświetlane są informacje o wersji dotyczące programu Chef Jacka Gumbo mieszanego](declarative-parameters-vb/_static/image14.png)](declarative-parameters-vb/_static/image13.png)
...
[![ADodaj pole tekstowe do strony zawierającej identyfikator CountryName](declarative-parameters-vb/_static/image17.png)](declarative-parameters-vb/_static/image16.png)
...
[![Cbierz metodę GetSuppliersByCountry(country)](declarative-parameters-vb/_static/image20.png)](declarative-parameters-vb/_static/image19.png)
...
[![SWartość tego parametru wartość kontrolki CountryName et](declarative-parameters-vb/_static/image23.png)](declarative-parameters-vb/_static/image22.png)
...
[![Twąż dostawców z Kanady są pokazywane](declarative-parameters-vb/_static/image26.png)](declarative-parameters-vb/_static/image25.png)
...
[![ADostawców LL są teraz wyświetlane domyślnie](declarative-parameters-vb/_static/image29.png)](declarative-parameters-vb/_static/image28.png)
