...
[![Rinformacje o produkcie przy użyciu metody GetProducts() owróć](handling-bll-and-dal-level-exceptions-vb/_static/image2.png)](handling-bll-and-dal-level-exceptions-vb/_static/image1.png)
...
[![Estacje produktu zawiera przycisk Edytuj](handling-bll-and-dal-level-exceptions-vb/_static/image5.png)](handling-bll-and-dal-level-exceptions-vb/_static/image4.png)
...
[![An komunikat o błędzie jest wyświetlany, jeśli użytkownik pomija wymagane pole](handling-bll-and-dal-level-exceptions-vb/_static/image9.png)](handling-bll-and-dal-level-exceptions-vb/_static/image8.png)
...
[![An komunikat o błędzie jest wyświetlany podczas wprowadzania ujemna Cena](handling-bll-and-dal-level-exceptions-vb/_static/image12.png)](handling-bll-and-dal-level-exceptions-vb/_static/image11.png)
