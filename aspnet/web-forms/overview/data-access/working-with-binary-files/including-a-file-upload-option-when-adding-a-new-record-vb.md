...
title: W tym pliku przekazywania opcji podczas dodawania nowego rekordu (VB) | Dokumentacja firmy Microsoft
...
[Pobierz przykładową aplikację](http://download.microsoft.com/download/4/a/7/4a7a3b18-d80e-4014-8e53-a6a2427f0d93/ASPNET_Data_Tutorial_56_VB.exe) lub [Pobierz plik PDF](including-a-file-upload-option-when-adding-a-new-record-vb/_static/datatutorial56vb1.pdf)
...
Po utworzeniu `CategoriesTableAdapter` w [Tworzenie warstwy dostępu do danych](../introduction/creating-a-data-access-layer-vb.md) samouczka został skonfigurowany do automatycznego generowania `INSERT`, `UPDATE`, i `DELETE` instrukcji na podstawie głównego zapytania. Ponadto firma Microsoft zgodnie z instrukcjami otrzymywanymi TableAdapter można wykorzystywać podejście bezpośredniego bazy danych, który metody `Insert`, `Update`, i `Delete`. Te metody wykonywania wygenerowany automatycznie `INSERT`, `UPDATE`, i `DELETE` instrukcji i w związku z tym, Zaakceptuj parametrów wejściowych, na podstawie kolumn zwrócony przez główne zapytanie. W [przesyłanie plików](uploading-files-vb.md) samouczka będziemy rozszerzone `CategoriesTableAdapter` s główne zapytanie do użycia `BrochurePath` kolumny.
...
[![SWybiera opcję Wstaw](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image1.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image1.png)

**Rysunek 1**: Wybierz opcję Wstaw ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image2.png))
...
[![NNazwa nowego InsertWithPicture metody TableAdapter](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image2.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image3.png)

**Rysunek 2**: Nadaj nazwę nowej metody TableAdapter `InsertWithPicture` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image4.png))
...
[![CKopiuj i Wklej składni deklaratywnej z DisplayOrDownload.aspx do UploadInDetailsView.aspx](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image3.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image5.png)

**Rysunek 3**: Skopiuj i Wklej składni deklaratywnej z `DisplayOrDownload.aspx` do `UploadInDetailsView.aspx` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image6.png))
...
[![Yjednostki organizacyjnej powinno być teraz wyświetlane w każdej kategorii, wraz z jego dane binarne](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image4.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image7.png)

**Rysunek 4**: Powinien zostać wyświetlony w każdej kategorii, wraz z jego danych binarnych ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image8.png))
...
[![Configuruj ObjectDataSource przy użyciu metody InsertWithPicture](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image5.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image9.png)

**Rysunek 5**: Konfigurowanie kontrolki ObjectDataSource używać `InsertWithPicture` — metoda ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image10.png))
...
[![BZnajdź DetailsView CategoriesDataSource i Włącz wstawianie](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image6.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image11.png)

**Rysunek 6**: Powiąż DetailsView do `CategoriesDataSource` i umożliwić wstawianie ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image12.png))
...
![Powiązywanie DetailsView CategoriesDataSource i umożliwić wstawianie](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image7.gif)
...
[![Add formantu InsertItemTemplate z przekazywaniem plików](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image8.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image13.png)

**Rysunek 8**: Dodawanie do formantu FileUpload `InsertItemTemplate` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image14.png))
...
[![A Ostrzeżenie jest wyświetlane, jeśli został przekazany nieprawidłowy typ pliku](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image9.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image15.png)
...
[![Tnie jest on nową kategorię s obraz wyświetlany](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image10.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image17.png)

**Na rysunku nr 10**: S nowej kategorii nie jest wyświetlany obraz ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image18.png))
...
[![TObrazów JPG on dla nowych kategorii są poprawnie renderowane](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image11.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image19.png)

**Rysunek 11**: Obrazów JPG dla nowych kategorii są poprawnie renderowane ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image20.png))
...
> [Poprzednie](displaying-binary-data-in-the-data-web-controls-vb.md)
> [dalej](updating-and-deleting-existing-binary-data-vb.md)
