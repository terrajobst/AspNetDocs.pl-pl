...
- DisabledButtonDesigner.cs — ta klasa umożliwia funkcjonalność czasu projektowania. Ta klasa jest konieczne, jeśli chcesz, aby rozszerzenie kontrolki w celu poprawnego działania z Visual Studio/Visual Web Developer Designer.
