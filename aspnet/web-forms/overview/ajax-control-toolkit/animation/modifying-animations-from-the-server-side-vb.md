...
[![TAnimacja he jest tworzony przy użyciu po stronie serwera C#/VB kod](modifying-animations-from-the-server-side-vb/_static/image2.png)](modifying-animations-from-the-server-side-vb/_static/image1.png)
