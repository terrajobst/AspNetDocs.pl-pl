...
title: Przypisywanie ról do użytkowników (VB) | Microsoft Docs
...
ms.locfileid: "74577860"
---
# <a name="assigning-roles-to-users-vb"></a>Przypisywanie ról do użytkowników (VB)

przez [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Pobierz kod](https://download.microsoft.com/download/6/0/3/6032582f-360d-4739-b935-38721fdb86ea/VB.10.zip) lub [Pobierz plik PDF](https://download.microsoft.com/download/6/0/3/6032582f-360d-4739-b935-38721fdb86ea/aspnet_tutorial10_AssigningRoles_vb.pdf)
...
[![Właściwość CssClass etykiety skutkuje dużą, czerwoną czcionką](assigning-roles-to-users-vb/_static/image2.png)](assigning-roles-to-users-vb/_static/image1.png)

**Rysunek 1**: Właściwość `CssClass` etykiety powoduje dużą, czerwoną czcionkę ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](assigning-roles-to-users-vb/_static/image3.png))
...
[![zostanie wyświetlona strona użytkownicy i role](assigning-roles-to-users-vb/_static/image5.png)](assigning-roles-to-users-vb/_static/image4.png)

**Rysunek 2**. na stronie są wyświetlane Użytkownicy i role ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](assigning-roles-to-users-vb/_static/image6.png))
...
> [!NOTE]
> Składnia `Linq.Enumerable.Contains(Of String)(...)` nie zostanie skompilowana, jeśli używany jest program ASP.NET w wersji 2,0. Metoda `Contains(Of String)` jest częścią [biblioteki LINQ](http://en.wikipedia.org/wiki/Language_Integrated_Query), która jest nowa dla ASP.NET 3,5. Jeśli nadal używasz programu ASP.NET w wersji 2,0, zamiast tego użyj [metody`Array.IndexOf(Of String)`](https://msdn.microsoft.com/library/eha9t187.aspx) .
...
[![Tito został dodany do ról Administratorzy i kierownicy](assigning-roles-to-users-vb/_static/image8.png)](assigning-roles-to-users-vb/_static/image7.png)

**Rysunek 3**. Tito został dodany do ról Administratorzy i kierownicy ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](assigning-roles-to-users-vb/_static/image9.png))
...
[![Bruce został dodany do roli kierownicy](assigning-roles-to-users-vb/_static/image11.png)](assigning-roles-to-users-vb/_static/image10.png)

**Rysunek 4**. Bruce został dodany do roli kierownicy ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](assigning-roles-to-users-vb/_static/image12.png))
...
**Rysunek 5**. role są wyświetlane w `RoleList` DropDownList (kliknij,[Aby wyświetlić obraz o pełnym rozmiarze](assigning-roles-to-users-vb/_static/image15.png))
...
[![GridView wyświetla listę użytkowników należących do wybranej roli](assigning-roles-to-users-vb/_static/image17.png)](assigning-roles-to-users-vb/_static/image16.png)

**Ilustracja 6**. widok GridView wyświetla listę użytkowników należących do wybranej roli ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](assigning-roles-to-users-vb/_static/image18.png))
...
[![dodać](assigning-roles-to-users-vb/_static/image20.png)](assigning-roles-to-users-vb/_static/image19.png)

**Rysunek 7**. Dodawanie przycisku "Usuń" do widoku GridView ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](assigning-roles-to-users-vb/_static/image21.png))
...
[![Niemniej, Tito nie jest już opiekunem](assigning-roles-to-users-vb/_static/image23.png)](assigning-roles-to-users-vb/_static/image22.png)

**Rysunek 8**: Niemniej, Tito nie jest już nadzorcą ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](assigning-roles-to-users-vb/_static/image24.png))
...
**Rysunek 9**: nie można dodać nieistniejącego użytkownika do roli ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](assigning-roles-to-users-vb/_static/image27.png))

Teraz spróbuj dodać prawidłowego użytkownika. Przejdź dalej i Dodaj Tito do roli kierownicy.

[![Tito jest ponownie nadzorcą!](assigning-roles-to-users-vb/_static/image29.png)](assigning-roles-to-users-vb/_static/image28.png)

**Rysunek 10**: Tito jest ponownie nadzorcą!  ([Kliknij, aby wyświetlić obraz o pełnym rozmiarze](assigning-roles-to-users-vb/_static/image30.png))
...
W przypadku tworzenia konta przez administratora dla innej osoby warto umożliwić administratorowi określenie ról, do których należy konto użytkownika. <a id="_msoanchor_4"> </a>W samouczku [ *przechowującym* *dodatkowe informacje o użytkowniku* ](../membership/storing-additional-user-information-vb.md) przedstawiono sposób dostosowywania formancie CreateUserWizard przez dodanie dodatkowych `WizardSteps`. Przyjrzyjmy się sposobom dodawania dodatkowego kroku do formancie CreateUserWizard w celu określenia ról nowego użytkownika.
...
[![dodać](assigning-roles-to-users-vb/_static/image32.png)](assigning-roles-to-users-vb/_static/image31.png)

**Ilustracja 11**. Dodawanie `WizardStep` "Określ role" do formancie CreateUserWizard ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](assigning-roles-to-users-vb/_static/image33.png))

Po wprowadzeniu tej zmiany deklaratywne znaczniki formancie CreateUserWizard powinny wyglądać następująco:

[!code-aspx[Main](assigning-roles-to-users-vb/samples/sample21.aspx)]

W `WizardStep`"Określ role" Dodaj element formant CheckBoxList o nazwie `RoleList.` ten formant CheckBoxList wyświetli listę dostępnych ról, umożliwiając osobie odwiedzającej stronę, aby sprawdzić, do jakich ról jest przynależny nowo utworzony użytkownik.
...
Powyższy kod powinien wyglądać znajomo. <a id="_msoanchor_5"> </a>W samouczku [ *przechowywanie* *dodatkowych informacji o użytkowniku* ](../membership/storing-additional-user-information-vb.md) użyto dwóch instrukcji `FindControl`, aby odwołać się do formantu sieci Web z poziomu `WizardStep`niestandardowego. Kod, który wiąże role z Formant CheckBoxList, został wykonany z wcześniej w tym samouczku.
...
[![utworzyć nowego użytkownika o nazwie Wanda](assigning-roles-to-users-vb/_static/image35.png)](assigning-roles-to-users-vb/_static/image34.png)

**Ilustracja 12**. Tworzenie nowego użytkownika o nazwie Wanda ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](assigning-roles-to-users-vb/_static/image36.png))
...
[![uczyń Wanda członkiem roli kierownicy](assigning-roles-to-users-vb/_static/image38.png)](assigning-roles-to-users-vb/_static/image37.png)

**Ilustracja 13**. Udostępnianie Wanda członkom roli kierownicy ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](assigning-roles-to-users-vb/_static/image39.png))
...
[![Bruce, Tito i Wanda to wszyscy kierownicy](assigning-roles-to-users-vb/_static/image41.png)](assigning-roles-to-users-vb/_static/image40.png)

**Ilustracja 14**. Bruce, Tito i Wanda to wszyscy kierownicy ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](assigning-roles-to-users-vb/_static/image42.png))
...
W tym momencie dowiesz się, jak tworzyć i usuwać role oraz jak dodawać i usuwać użytkowników z ról. Jednak zapoznaj się z zastosowaniem autoryzacji opartej na rolach. <a id="_msoanchor_6"> </a>W [poniższym samouczku](role-based-authorization-vb.md) opisano definiowanie reguł autoryzacji adresów URL na podstawie ról, a także Ograniczanie funkcjonalności na poziomie strony na podstawie aktualnie zalogowanych ról użytkownika.
