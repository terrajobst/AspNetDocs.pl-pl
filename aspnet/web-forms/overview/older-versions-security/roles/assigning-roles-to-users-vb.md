...
[![TEtykieta HE CssClass właściwość skutkuje duże, czcionka Red](assigning-roles-to-users-vb/_static/image2.png)](assigning-roles-to-users-vb/_static/image1.png)
...
[![TZawiera on strony, użytkownikami i rolami](assigning-roles-to-users-vb/_static/image5.png)](assigning-roles-to-users-vb/_static/image4.png)
...
[![Tpawłowski została dodana do administratorów i ról nadzorców](assigning-roles-to-users-vb/_static/image8.png)](assigning-roles-to-users-vb/_static/image7.png)
...
[![Bruce został dodany do roli nadzorców](assigning-roles-to-users-vb/_static/image11.png)](assigning-roles-to-users-vb/_static/image10.png)
...
[![TRole HE są wyświetlane w RoleList DropDownList](assigning-roles-to-users-vb/_static/image14.png)](assigning-roles-to-users-vb/_static/image13.png)
...
[![Tzawiera on GridView listę użytkowników, którzy należą do tej roli systemu zaznaczone](assigning-roles-to-users-vb/_static/image17.png)](assigning-roles-to-users-vb/_static/image16.png)
...
[![Alas, Tito nie jest już nadzorcy](assigning-roles-to-users-vb/_static/image23.png)](assigning-roles-to-users-vb/_static/image22.png)
...
[![Yjednostki organizacyjnej nie można dodać użytkownika nieistniejąca rolę](assigning-roles-to-users-vb/_static/image26.png)](assigning-roles-to-users-vb/_static/image25.png)
...
[![Tpawłowski to ponownie nadzorcy!](assigning-roles-to-users-vb/_static/image29.png)](assigning-roles-to-users-vb/_static/image28.png)
...
[![CTwórz nowe Wanda o nazwie użytkownika](assigning-roles-to-users-vb/_static/image35.png)](assigning-roles-to-users-vb/_static/image34.png)
...
[![MOznacz Wanda członkiem roli nadzorców](assigning-roles-to-users-vb/_static/image38.png)](assigning-roles-to-users-vb/_static/image37.png)
...
[![Bruce Tito i Wanda są wszystkie nadzorców](assigning-roles-to-users-vb/_static/image41.png)](assigning-roles-to-users-vb/_static/image40.png)
