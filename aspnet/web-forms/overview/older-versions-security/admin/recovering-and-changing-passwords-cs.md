...
ms.locfileid: "78566879"
---
# <a name="recovering-and-changing-passwords-c"></a>Odzyskiwanie i zmienianie haseł (C#)

przez [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Pobierz kod](https://download.microsoft.com/download/6/0/e/60e1bd94-e5f9-4d5a-a079-f23c98f4f67d/CS.13.zip) lub [Pobierz plik PDF](https://download.microsoft.com/download/6/0/e/60e1bd94-e5f9-4d5a-a079-f23c98f4f67d/aspnet_tutorial13_ChangingPasswords_cs.pdf)
...
[![RequiresQuestionAndAnswer, EnablePasswordRetrieval i EnablePasswordReset wpływają na wygląd i zachowanie kontrolki PasswordRecovery](recovering-and-changing-passwords-cs/_static/image2.png)](recovering-and-changing-passwords-cs/_static/image1.png)

**Rysunek 1**. `RequiresQuestionAndAnswer`, `EnablePasswordRetrieval`i `EnablePasswordReset` wpływają na wygląd i zachowanie kontrolki PasswordRecovery ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image3.png))
...
[![zostanie wyświetlony komunikat o błędzie w przypadku wprowadzenia nieprawidłowej nazwy użytkownika](recovering-and-changing-passwords-cs/_static/image5.png)](recovering-and-changing-passwords-cs/_static/image4.png)

**Rysunek 2**. komunikat o błędzie jest wyświetlany po wprowadzeniu nieprawidłowej nazwy użytkownika ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image6.png))
...
[![komunikat o błędzie jest wyświetlany, gdy użytkownik wprowadzi nieprawidłową odpowiedź zabezpieczeń](recovering-and-changing-passwords-cs/_static/image8.png)](recovering-and-changing-passwords-cs/_static/image7.png)

**Rysunek 3**. komunikat o błędzie jest wyświetlany, gdy użytkownik wprowadzi nieprawidłową odpowiedź zabezpieczeń ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image9.png))
...
[![użytkownik wysyła wiadomość E-mail z nowym hasłem](recovering-and-changing-passwords-cs/_static/image11.png)](recovering-and-changing-passwords-cs/_static/image10.png)

**Rysunek 4**. użytkownik otrzymuje wiadomość E-mail z nowym hasłem ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image12.png))
...
[![Zaktualizowano temat, treść i lista DW](recovering-and-changing-passwords-cs/_static/image14.png)](recovering-and-changing-passwords-cs/_static/image13.png)

**Rysunek 5**: Zaktualizowano temat, treść i listę DW ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image15.png))
...
- Zablokowany użytkownik nie może zresetować swojego hasła. Jednak niezatwierdzony użytkownik może. W samouczku <a id="_msoanchor_3"> </a> [*odblokowywanie i zatwierdzanie kont użytkowników*](unlocking-and-approving-user-accounts-cs.md) zawarto szczegółowe informacje o zablokowanych i zatwierdzonych Stanach.
...
[![dodać kontrolki ChangePassword do strony](recovering-and-changing-passwords-cs/_static/image17.png)](recovering-and-changing-passwords-cs/_static/image16.png)

**Ilustracja 6**. Dodawanie kontrolki ChangePassword do strony ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image18.png))
...
[![dodać kontrolki ChangePassword do strony](recovering-and-changing-passwords-cs/_static/image20.png)](recovering-and-changing-passwords-cs/_static/image19.png)

**Rysunek 7**. Dodawanie kontrolki ChangePassword do strony ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image21.png))
...
[![wiadomość E-mail informuje użytkownika, że jego hasło zostało zmienione](recovering-and-changing-passwords-cs/_static/image23.png)](recovering-and-changing-passwords-cs/_static/image22.png)

**Ilustracja 8**. wiadomość E-mail informuje użytkownika, że jego hasło zostało zmienione ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image24.png))
...
**Rysunek 9**. Administrator może zmienić hasło użytkownika ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image27.png))
