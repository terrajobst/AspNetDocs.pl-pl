...
[![TADAM RequiresQuestionAndAnswer EnablePasswordRetrieval i EnablePasswordReset mają wpływ na formant PasswordRecovery wygląd i zachowanie](recovering-and-changing-passwords-cs/_static/image2.png)](recovering-and-changing-passwords-cs/_static/image1.png)
...
[![An komunikat o błędzie jest wyświetlany, jeśli podano nieprawidłową nazwę użytkownika](recovering-and-changing-passwords-cs/_static/image5.png)](recovering-and-changing-passwords-cs/_static/image4.png)
...
[![An komunikat o błędzie jest wyświetlany, jeśli użytkownik wprowadzi nieprawidłowe odpowiedzi zabezpieczeń](recovering-and-changing-passwords-cs/_static/image8.png)](recovering-and-changing-passwords-cs/_static/image7.png)
...
[![TADAM, użytkownik otrzymuje wiadomość E-mail z jego nowe hasło](recovering-and-changing-passwords-cs/_static/image11.png)](recovering-and-changing-passwords-cs/_static/image10.png)
...
[![TADAM tematu, treści i DW listy zostały zaktualizowane](recovering-and-changing-passwords-cs/_static/image14.png)](recovering-and-changing-passwords-cs/_static/image13.png)
...
[![AKontrolka ChangePassword do strony dd](recovering-and-changing-passwords-cs/_static/image17.png)](recovering-and-changing-passwords-cs/_static/image16.png)
...
[![AKontrolka ChangePassword do strony dd](recovering-and-changing-passwords-cs/_static/image20.png)](recovering-and-changing-passwords-cs/_static/image19.png)
...
[![An E-mail wyświetlony komunikat z informacją, ich hasło użytkownika został zmieniony](recovering-and-changing-passwords-cs/_static/image23.png)](recovering-and-changing-passwords-cs/_static/image22.png)
...
[![An Administrator może zmienić hasła użytkownika](recovering-and-changing-passwords-cs/_static/image26.png)](recovering-and-changing-passwords-cs/_static/image25.png)
