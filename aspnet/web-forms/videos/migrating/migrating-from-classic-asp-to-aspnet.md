...
---
# <a name="migrating-from-classic-asp-to-aspnet"></a>[Migrowanie z] Klasyczne środowisko ASP na platformę ASP.NET

przez [firmy Microsoft](https://github.com/microsoft)

Czy planowane jest migracja z klasycznego środowiska ASP do programu Microsoft ASP.NET 2.0? Ta seria emisję internetową, która przeprowadzi Cię przez zagadnienia istotne kwestie projektowania architektonicznego, należy pamiętać, planując strategię migracji.

[&#9654;Obejrzyj film wideo (78 w minutach)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/migrating-from-classic-asp-to-aspnet)
