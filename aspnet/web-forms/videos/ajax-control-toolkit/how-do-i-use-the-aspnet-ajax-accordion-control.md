...
---
# <a name="how-do-i-use-the-aspnet-ajax-accordion-control"></a>[Jak mogę] Użyj kontrolka Accordion ASP.NET AJAX?

przez [Stagner Jan](https://github.com/JoeStagner)

Dowiedz się, jak formant ASP.NET AJAX w właściwości Accordion ułatwia efektywne wykorzystanie powierzchnię ekranu poprzez umożliwienie animowany przejścia między różnymi okienkami zawartości.

[&#9654;Obejrzyj film wideo (9 min)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-use-the-aspnet-ajax-accordion-control)
