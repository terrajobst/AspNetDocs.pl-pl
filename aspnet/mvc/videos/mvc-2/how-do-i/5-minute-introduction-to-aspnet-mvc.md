...
---
# <a name="5-minute-introduction-to-aspnet-mvc"></a>5 minut wprowadzenia do ASP.NET MVC

przez [Scott Hanselman](https://github.com/shanselman)

Scott Hanselman przedstawia 5-minutowe wprowadzenie do ASP.NET MVC.

[&#9654;Obejrzyj wideo (8 minut)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/5-minute-introduction-to-aspnet-mvc)
