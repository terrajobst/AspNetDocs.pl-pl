...
---
# <a name="mvc-music-store-part-3-views-and-viewmodels"></a>Sklep MVC Music Store — część 3: widoki i modele widoków

przez [Galloway'em Jon](https://github.com/jongalloway)

Jan kontynuuje MVC Music Store samouczka Wprowadzenie do strony wzorcowe, widoki i modele widoków.

[&#9654;Obejrzyj film wideo (minuty 13)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/mvc-music-store-part-3-views-and-viewmodels)
