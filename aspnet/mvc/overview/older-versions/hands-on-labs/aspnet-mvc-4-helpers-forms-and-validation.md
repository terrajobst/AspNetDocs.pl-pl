...
1. [<span data-ttu-id="c85a0-139">Tworzenie kontrolera Store Manager i jej widok indeksu</span><span class="sxs-lookup"><span data-stu-id="c85a0-139">Creating the Store Manager controller and its Index view</span></span>](#Exercise1)
...
<span data-ttu-id="c85a0-152">W tym zadaniu utworzysz nowy kontroler o nazwie **StoreManagerController** do obsługi operacji CRUD.</span><span class="sxs-lookup"><span data-stu-id="c85a0-152">In this task, you will create a new controller called **StoreManagerController** to support CRUD operations.</span></span>
...
2. <span data-ttu-id="c85a0-161">Dodaj nowy kontroler.</span><span class="sxs-lookup"><span data-stu-id="c85a0-161">Add a new controller.</span></span> <span data-ttu-id="c85a0-162">Aby to zrobić, kliknij prawym przyciskiem myszy **kontrolerów** folder w Eksploratorze rozwiązań, wybierz pozycję **Dodaj** i następnie **kontrolera** polecenia.</span><span class="sxs-lookup"><span data-stu-id="c85a0-162">To do this, right-click the **Controllers** folder within the Solution Explorer, select **Add** and then the **Controller** command.</span></span> <span data-ttu-id="c85a0-163">Zmiana **kontrolera** **nazwa** do **StoreManagerController** i upewnić się, że opcja **kontroler MVC z akcjami odczytu/zapisu pusty**jest zaznaczone.</span><span class="sxs-lookup"><span data-stu-id="c85a0-163">Change the **Controller** **Name** to **StoreManagerController** and make sure the option **MVC controller with empty read/write actions** is selected.</span></span> <span data-ttu-id="c85a0-164">Kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-164">Click **Add**.</span></span>
    ...
    <span data-ttu-id="c85a0-166">*Dodaj kontroler, okno dialogowe*</span><span class="sxs-lookup"><span data-stu-id="c85a0-166">*Add Controller Dialog*</span></span>
...
3. <span data-ttu-id="c85a0-175">Implementowanie akcji indeksu StoreManagerController do zwrócenia widoku z listy albumów.</span><span class="sxs-lookup"><span data-stu-id="c85a0-175">Implement the StoreManagerController Index action to return a View with the list of albums.</span></span>
    ...
    <span data-ttu-id="c85a0-178">(Code Snippet — *pomocników platformy ASP.NET MVC 4 i formularze i Walidacja — indeks StoreManagerController Ex1*)</span><span class="sxs-lookup"><span data-stu-id="c85a0-178">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex1 StoreManagerController Index*)</span></span>
...
3. <span data-ttu-id="c85a0-187">W oknie dialogowym Dodaj widok, sprawdź, czy nazwa widoku jest **indeksu**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-187">In the Add View dialog, verify that the View Name is **Index**.</span></span> <span data-ttu-id="c85a0-188">Wybierz **utworzyć widok silnie typizowane** opcji, a następnie wybierz **albumu (MvcMusicStore.Models)** z **klasa modelu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-188">Select the **Create a strongly-typed view** option, and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="c85a0-189">Wybierz **listy** z **szablonu szkieletu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-189">Select **List** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="c85a0-190">Pozostaw **aparat widoku** do **Razor** i inne pola z ich domyślną wartość, a następnie kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-190">Leave the **View engine** to **Razor** and the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="c85a0-192">*Dodawanie widoku indeksu*</span><span class="sxs-lookup"><span data-stu-id="c85a0-192">*Adding an Index View*</span></span>
...
<span data-ttu-id="c85a0-215">*Przeglądanie listy albumy ze nie obcięty tekst*</span><span class="sxs-lookup"><span data-stu-id="c85a0-215">*Browsing the list of Albums with not truncated text*</span></span>
...
2. <span data-ttu-id="c85a0-242">Data rozpoczęcia projektu na stronie głównej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-242">The project starts in the Home page.</span></span> <span data-ttu-id="c85a0-243">Zmień adres URL do **/StoreManager** Aby sprawdzić, okres czasu teksty w **tytuł** i **wykonawcy** kolumny są obcinane.</span><span class="sxs-lookup"><span data-stu-id="c85a0-243">Change the URL to **/StoreManager** to verify that long texts in the **Title** and **Artist** column are truncated.</span></span>
    ...
    <span data-ttu-id="c85a0-244">![Obcięte nazwy tytułów i artystów](aspnet-mvc-4-helpers-forms-and-validation/_static/image6.png "obcięte nazwy tytułów i artystów")</span><span class="sxs-lookup"><span data-stu-id="c85a0-244">![Truncated titles and artists names](aspnet-mvc-4-helpers-forms-and-validation/_static/image6.png "Truncated titles and artists names")</span></span>
...
3. <span data-ttu-id="c85a0-266">Zastąp **Edytuj HTTP GET** metodę akcji za pomocą następującego kodu, aby pobrać odpowiednią **albumu** , jak również **gatunki** i **artystów**listy.</span><span class="sxs-lookup"><span data-stu-id="c85a0-266">Replace the **HTTP-GET Edit** action method with the following code to retrieve the appropriate **Album** as well as the **Genres** and **Artists** lists.</span></span>
    ...
    <span data-ttu-id="c85a0-267">(Code Snippet — *pomocników programu ASP.NET MVC 4 i formularze i Walidacja - Ex3 StoreManagerController HTTP GET Edytuj akcję*)</span><span class="sxs-lookup"><span data-stu-id="c85a0-267">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex3 StoreManagerController HTTP-GET Edit action*)</span></span>
...
2. <span data-ttu-id="c85a0-275">W oknie dialogowym Dodaj widok, sprawdź, czy nazwa widoku jest **Edytuj**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-275">In the Add View dialog, verify that the View Name is **Edit**.</span></span> <span data-ttu-id="c85a0-276">Sprawdź **utworzyć widok silnie typizowane** pole wyboru i wybierz **albumu (MvcMusicStore.Models)** z **wyświetlić klasy danych** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-276">Check the **Create a strongly-typed view** checkbox and select **Album (MvcMusicStore.Models)** from the **View data class** drop-down.</span></span> <span data-ttu-id="c85a0-277">Wybierz **Edytuj** z **szablonu szkieletu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-277">Select **Edit** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="c85a0-278">Pozostaw wartości domyślne w pozostałych polach, a następnie kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-278">Leave the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="c85a0-280">*Dodawanie widoku edycji*</span><span class="sxs-lookup"><span data-stu-id="c85a0-280">*Adding an Edit view*</span></span>
...
1. <span data-ttu-id="c85a0-290">Zamień wszystkie **albumu** fieldset kod następującym kodem:</span><span class="sxs-lookup"><span data-stu-id="c85a0-290">Replace all the **Album** fieldset code with the following:</span></span>
    ...
    > 2. <span data-ttu-id="c85a0-294">**SelectList** wartości z listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-294">The **SelectList** of values for the drop-down.</span></span>
...
2. <span data-ttu-id="c85a0-306">Zastąp **edytować żądania HTTP POST** kod do metody akcji przy użyciu następujących (należy pamiętać, że metoda, którą należy zastąpić przeciążona wersja, która otrzymuje dwa parametry):</span><span class="sxs-lookup"><span data-stu-id="c85a0-306">Replace **HTTP-POST Edit** action method code with the following (note that the method that must be replaced is overloaded version that receives two parameters):</span></span>
    ...
    <span data-ttu-id="c85a0-307">(Code Snippet — *pomocników programu ASP.NET MVC 4 i formularze i Walidacja - Ex3 StoreManagerController żądania HTTP POST Edytuj akcję*)</span><span class="sxs-lookup"><span data-stu-id="c85a0-307">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex3 StoreManagerController HTTP-POST Edit action*)</span></span>
...
1. <span data-ttu-id="c85a0-319">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-319">Press **F5** to run the Application.</span></span>
...
1. <span data-ttu-id="c85a0-358">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-358">Press **F5** to run the Application.</span></span>
...
1. <span data-ttu-id="c85a0-392">Otwórz **rozpocząć** rozwiązania znajdujący się w **źródło/Ex5-HandlingDeletion/rozpoczęcia/** folderu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-392">Open the **Begin** solution located at **Source/Ex5-HandlingDeletion/Begin/** folder.</span></span> <span data-ttu-id="c85a0-393">W przeciwnym razie będziesz nadal korzystać z **zakończenia** rozwiązania uzyskać, wykonując poprzednim ćwiczeniu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-393">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>
   ...
   3. <span data-ttu-id="c85a0-397">Na koniec Skompiluj rozwiązanie, klikając **kompilacji** | **Kompiluj rozwiązanie**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-397">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>
      ...
      > [!NOTE]
      > <span data-ttu-id="c85a0-398">Jedną z zalet za pomocą narzędzia NuGet jest, że nie masz do wysłania wszystkie biblioteki w projekcie, zmniejszenie rozmiaru projektu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-398">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="c85a0-399">Za pomocą narzędzi NuGet Power Tools, określając wersji pakietu w pliku Packages.config można pobrać wymaganych bibliotek podczas pierwszego uruchomienia projektu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-399">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="c85a0-400">Jest to, dlaczego należy uruchomić następujące kroki, po otwarciu istniejącego rozwiązania, w tym środowisku laboratoryjnym.</span><span class="sxs-lookup"><span data-stu-id="c85a0-400">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="c85a0-401">Otwórz **StoreManagerController** klasy.</span><span class="sxs-lookup"><span data-stu-id="c85a0-401">Open **StoreManagerController** class.</span></span> <span data-ttu-id="c85a0-402">Aby to zrobić, należy rozwinąć **kontrolerów** folder i kliknij dwukrotnie plik **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-402">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
3. <span data-ttu-id="c85a0-403">Usuwanie akcji kontrolera jest dokładnie taka sama poprzedniej akcji kontrolera szczegóły Store: zapytań **albumu** obiektu z bazy danych przy użyciu **identyfikator** podany adres URL i zwraca odpowiednie **widoku**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-403">The Delete controller action is exactly the same as the previous Store Details controller action: it queries the **album** object from the database using the **id** provided in the URL and returns the appropriate **View**.</span></span> <span data-ttu-id="c85a0-404">Aby to zrobić, Zastąp HTTP GET **Usuń** kod do metody akcji następującym kodem:</span><span class="sxs-lookup"><span data-stu-id="c85a0-404">To do this, replace the HTTP-GET **Delete** action method code with the following:</span></span>

    <span data-ttu-id="c85a0-405">(Code Snippet — *pomocników programu ASP.NET MVC 4 i formularze i Walidacja - Ex5 obsługi usuwania HTTP GET usunąć akcję*)</span><span class="sxs-lookup"><span data-stu-id="c85a0-405">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-GET Delete action*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample15.cs)]
4. <span data-ttu-id="c85a0-406">Kliknij prawym przyciskiem myszy wewnątrz **Usuń** metody akcji i wybierz **Dodaj widok**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-406">Right-click inside the **Delete** action method and select **Add View**.</span></span> <span data-ttu-id="c85a0-407">Zostanie wyświetlone okno dialogowe dodawania widoku.</span><span class="sxs-lookup"><span data-stu-id="c85a0-407">This will bring up the Add View dialog.</span></span>
5. <span data-ttu-id="c85a0-408">W oknie dialogowym Dodaj widok, sprawdź, czy nazwa widoku jest **Usuń**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="c85a0-409">Wybierz **utworzyć widok silnie typizowane** opcji, a następnie wybierz pozycję **albumu (MvcMusicStore.Models)** z **klasa modelu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="c85a0-410">Wybierz **Usuń** z **szablonu szkieletu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="c85a0-411">Pozostaw wartości domyślne w pozostałych polach, a następnie kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="c85a0-412">![Dodawanie widoku Delete](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Dodawanie widoku Delete")</span><span class="sxs-lookup"><span data-stu-id="c85a0-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="c85a0-413">*Dodawanie widoku Delete*</span><span class="sxs-lookup"><span data-stu-id="c85a0-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="c85a0-414">Usuń szablon zawiera wszystkie pola z modelu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="c85a0-415">Zostaną wyświetlone tylko tytuł albumu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-415">You will show only the album's title.</span></span> <span data-ttu-id="c85a0-416">Aby to zrobić, Zastąp zawartość widoku z następującym kodem:</span><span class="sxs-lookup"><span data-stu-id="c85a0-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="c85a0-417">Zadanie 2 — uruchamianie aplikacji</span><span class="sxs-lookup"><span data-stu-id="c85a0-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="c85a0-418">W tym zadaniu przetestujesz, **StoreManager** **Usuń** widoku strony wyświetla formularz potwierdzenie usunięcia.</span><span class="sxs-lookup"><span data-stu-id="c85a0-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="c85a0-419">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="c85a0-420">Data rozpoczęcia projektu na stronie głównej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-420">The project starts in the Home page.</span></span> <span data-ttu-id="c85a0-421">Zmień adres URL do **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="c85a0-422">Wybierz jeden album można usunąć, klikając **Usuń** i sprawdź, czy zostanie przekazany nowy widok.</span><span class="sxs-lookup"><span data-stu-id="c85a0-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="c85a0-423">![Usuwanie albumu](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Usuwanie albumu")</span><span class="sxs-lookup"><span data-stu-id="c85a0-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="c85a0-424">*Usuwanie albumu*</span><span class="sxs-lookup"><span data-stu-id="c85a0-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="c85a0-425">Zadanie 3 — implementacja metody akcji usuwania POST protokołu HTTP</span><span class="sxs-lookup"><span data-stu-id="c85a0-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="c85a0-426">W tym zadaniu będą wdrażać wersję POST protokołu HTTP, Usuń metody akcji, która będzie wywołana, gdy użytkownik kliknie **Usuń** przycisku.</span><span class="sxs-lookup"><span data-stu-id="c85a0-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="c85a0-427">Metoda, należy usunąć albumu w bazie danych.</span><span class="sxs-lookup"><span data-stu-id="c85a0-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="c85a0-428">Zamknij przeglądarkę, jeśli to konieczne, aby powrócić do okna programu Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="c85a0-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="c85a0-429">Otwórz **StoreManagerController** klasy.</span><span class="sxs-lookup"><span data-stu-id="c85a0-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="c85a0-430">Aby to zrobić, należy rozwinąć **kontrolerów** folder i kliknij dwukrotnie plik **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="c85a0-431">Zastąp **POST protokołu HTTP, Usuń** kod do metody akcji następującym kodem:</span><span class="sxs-lookup"><span data-stu-id="c85a0-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="c85a0-432">(Code Snippet — *pomocników programu ASP.NET MVC 4 i formularze i Walidacja - Ex5 obsługi usuwania żądania HTTP POST akcji*)</span><span class="sxs-lookup"><span data-stu-id="c85a0-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="c85a0-433">Zadanie 4 — uruchamianie aplikacji</span><span class="sxs-lookup"><span data-stu-id="c85a0-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="c85a0-434">W tym zadaniu przetestujesz, **StoreManager Delete** strona widoku służy do usuwania albumu, a następnie przekierowuje do widoku indeksu StoreManager.</span><span class="sxs-lookup"><span data-stu-id="c85a0-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="c85a0-435">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="c85a0-436">Data rozpoczęcia projektu na stronie głównej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-436">The project starts in the Home page.</span></span> <span data-ttu-id="c85a0-437">Zmień adres URL do **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="c85a0-438">Wybierz jeden album można usunąć, klikając **usunąć.**</span><span class="sxs-lookup"><span data-stu-id="c85a0-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="c85a0-439">Potwierdzenie usunięcia, klikając **Usuń** przycisku:</span><span class="sxs-lookup"><span data-stu-id="c85a0-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="c85a0-440">![Usuwanie albumu](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Usuwanie albumu")</span><span class="sxs-lookup"><span data-stu-id="c85a0-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="c85a0-441">*Usuwanie albumu*</span><span class="sxs-lookup"><span data-stu-id="c85a0-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="c85a0-442">Sprawdź, czy album została usunięta, ponieważ nie ma w **indeksu** strony.</span><span class="sxs-lookup"><span data-stu-id="c85a0-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="c85a0-443">Ćwiczenie 6: Dodawanie walidacji</span><span class="sxs-lookup"><span data-stu-id="c85a0-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="c85a0-444">Obecnie tworzyć i edytować formularze, które zostały spełnione, nie należy wykonywać wszelkiego rodzaju sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="c85a0-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="c85a0-445">Jeśli użytkownik opuści wymagane pole jest puste lub typ liter w polu Cena, pierwszy błąd, który zostanie wyświetlony będzie z bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c85a0-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="c85a0-446">Aby dodać sprawdzanie poprawności do aplikacji, dodawanie adnotacji danych do klasy modelu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="c85a0-447">Adnotacje danych Zezwalaj, zawierająca opis reguły, które mają stosowane do właściwości modelu i platformy ASP.NET MVC zajmie się wymuszanie i wyświetlania odpowiedni komunikat do użytkowników.</span><span class="sxs-lookup"><span data-stu-id="c85a0-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="c85a0-448">Zadanie 1 — Dodawanie adnotacji danych</span><span class="sxs-lookup"><span data-stu-id="c85a0-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="c85a0-449">W ramach tego zadania zostaną dodane adnotacje danych do modelu fotograficzne, który spowoduje, że strona tworzyć i edytować wyświetlanie komunikatów dotyczących sprawdzania poprawności, gdy jest to konieczne.</span><span class="sxs-lookup"><span data-stu-id="c85a0-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="c85a0-450">Proste klasy modelu, dodawanie adnotacji danych po prostu odbywa się przez dodanie **przy użyciu** poufności informacji dotyczące **System.ComponentModel.DataAnnotation**, następnie umieszczenie **[wymagane]** atrybutu odpowiednie właściwości.</span><span class="sxs-lookup"><span data-stu-id="c85a0-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="c85a0-451">Poniższy przykład czyniłyby **nazwa** właściwości wymagane pola w widoku.</span><span class="sxs-lookup"><span data-stu-id="c85a0-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="c85a0-452">Jest to nieco bardziej złożone, w przypadkach, takich jak tej aplikacji, gdzie jest generowany modelu Entity Data Model.</span><span class="sxs-lookup"><span data-stu-id="c85a0-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="c85a0-453">Jeśli dodano adnotacje danych bezpośrednio do klasy modeli, ich zostaną zastąpione po aktualizacji modelu z bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c85a0-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="c85a0-454">Zamiast tego można tworzyć z metadanych klas częściowych, które będzie istnieć do przechowywania adnotacje i skojarzone z modelu należy używać klas, za pomocą **[MetadataType]** atrybutu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="c85a0-455">Otwórz **rozpocząć** rozwiązania znajdujący się w **źródło/Ex6-AddingValidation/rozpoczęcia/** folderu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="c85a0-456">W przeciwnym razie będziesz nadal korzystać z **zakończenia** rozwiązania uzyskać, wykonując poprzednim ćwiczeniu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="c85a0-457">Jeśli został otwarty dołączonym **rozpocząć** rozwiązania, należy pobrać niektóre brakujące pakiety NuGet przed kontynuowaniem.</span><span class="sxs-lookup"><span data-stu-id="c85a0-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="c85a0-458">Aby to zrobić, kliknij przycisk **projektu** menu, a następnie wybierz **Zarządzaj pakietami NuGet**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="c85a0-459">W **Zarządzaj pakietami NuGet** okno dialogowe, kliknij przycisk **przywrócić** Aby pobrać brakujące pakiety.</span><span class="sxs-lookup"><span data-stu-id="c85a0-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="c85a0-460">Na koniec Skompiluj rozwiązanie, klikając **kompilacji** | **Kompiluj rozwiązanie**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="c85a0-461">Jedną z zalet za pomocą narzędzia NuGet jest, że nie masz do wysłania wszystkie biblioteki w projekcie, zmniejszenie rozmiaru projektu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="c85a0-462">Za pomocą narzędzi NuGet Power Tools, określając wersji pakietu w pliku Packages.config można pobrać wymaganych bibliotek podczas pierwszego uruchomienia projektu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="c85a0-463">Jest to, dlaczego należy uruchomić następujące kroki, po otwarciu istniejącego rozwiązania, w tym środowisku laboratoryjnym.</span><span class="sxs-lookup"><span data-stu-id="c85a0-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="c85a0-464">Otwórz **Album.cs** z **modeli** folderu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="c85a0-465">Zastąp **Album.cs** zawartości ze wyróżniony kod, tak że wygląda podobnie do poniższego:</span><span class="sxs-lookup"><span data-stu-id="c85a0-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="c85a0-466">Wiersz **[DisplayFormat(ConvertEmptyStringToNull=false)]** wskazuje, czy puste ciągi z modelu nie zostaną przekonwertowane na wartości null, po zaktualizowaniu pola danych w źródle danych.</span><span class="sxs-lookup"><span data-stu-id="c85a0-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="c85a0-467">To ustawienie pozwoli uniknąć wyjątek, gdy platforma Entity Framework przypisuje wartości null do modelu przed adnotacji danych sprawdza poprawność pól.</span><span class="sxs-lookup"><span data-stu-id="c85a0-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="c85a0-468">(Code Snippet — *pomocników programu ASP.NET MVC 4 i formularze i Walidacja - klasy częściowej metadanych albumu Ex6*)</span><span class="sxs-lookup"><span data-stu-id="c85a0-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="c85a0-469">To **albumu** częściowa klasa ma **MetadataType** atrybut, który wskazuje na **AlbumMetaData** klasy dla adnotacji danych.</span><span class="sxs-lookup"><span data-stu-id="c85a0-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="c85a0-470">Oto niektóre atrybuty adnotacji danych, których używasz dodawać adnotacje do modelu albumu:</span><span class="sxs-lookup"><span data-stu-id="c85a0-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="c85a0-471">Niewymagana — wskazuje, że właściwość jest polem wymaganym</span><span class="sxs-lookup"><span data-stu-id="c85a0-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="c85a0-472">DisplayName — Określa tekst, który ma być używany na pola formularza i komunikatów dotyczących sprawdzania poprawności</span><span class="sxs-lookup"><span data-stu-id="c85a0-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="c85a0-473">DisplayFormat — określa sposób wyświetlania i sformatowane pola danych.</span><span class="sxs-lookup"><span data-stu-id="c85a0-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="c85a0-474">StringLength - określa maksymalną długość pola ciągu</span><span class="sxs-lookup"><span data-stu-id="c85a0-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="c85a0-475">Zakres — zapewnia maksymalne i minimalne wartości pola numerycznego</span><span class="sxs-lookup"><span data-stu-id="c85a0-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="c85a0-476">ScaffoldColumn — umożliwia ukrycie pola w edytorze formularzy</span><span class="sxs-lookup"><span data-stu-id="c85a0-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="c85a0-477">Zadanie 2 — uruchamianie aplikacji</span><span class="sxs-lookup"><span data-stu-id="c85a0-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="c85a0-478">W tym zadaniu przetestujesz, tworzyć i edytować stron sprawdzanie poprawności pola, przy użyciu nazw wyświetlanych wybrany w poprzednim zadaniu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="c85a0-479">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="c85a0-480">Data rozpoczęcia projektu na stronie głównej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-480">The project starts in the Home page.</span></span> <span data-ttu-id="c85a0-481">Zmień adres URL do **/StoreManager/tworzenie**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="c85a0-482">Sprawdź, czy nazwy wyświetlane zgodne z typami klasy częściowej (takich jak **URL grafikę albumu** zamiast **AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="c85a0-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="c85a0-483">Kliknij przycisk **Utwórz**, bez wypełniania formularza.</span><span class="sxs-lookup"><span data-stu-id="c85a0-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="c85a0-484">Upewnij się, że otrzymasz odpowiednie komunikaty sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="c85a0-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="c85a0-485">![Zweryfikowane pola na stronie Utwórz](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "zweryfikowane pola na stronie Utwórz")</span><span class="sxs-lookup"><span data-stu-id="c85a0-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="c85a0-486">*Sprawdzone pola na stronie Utwórz*</span><span class="sxs-lookup"><span data-stu-id="c85a0-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="c85a0-487">Możesz sprawdzić, że takie same odbywa się za pomocą **Edytuj** strony.</span><span class="sxs-lookup"><span data-stu-id="c85a0-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="c85a0-488">Zmień adres URL do **/StoreManager/Edit/1** i sprawdź, czy nazwy wyświetlane zgodne z typami klasy częściowej (takich jak **URL grafikę albumu** zamiast **AlbumArtUrl**).</span><span class="sxs-lookup"><span data-stu-id="c85a0-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="c85a0-489">Pusty **tytuł** i **cena** pola i kliknij przycisk **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="c85a0-490">Upewnij się, że otrzymasz odpowiednie komunikaty sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="c85a0-490">Verify that you get the corresponding validation messages.</span></span>

    ![Sprawdzone pola na stronie edycji](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="c85a0-492">*Sprawdzone pola na stronie edycji*</span><span class="sxs-lookup"><span data-stu-id="c85a0-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="c85a0-493">Ćwiczenie 7: Przy użyciu jQuery dyskretny kod po stronie klienta</span><span class="sxs-lookup"><span data-stu-id="c85a0-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="c85a0-494">W tym ćwiczeniu dowiesz się, jak włączyć dotyczącą weryfikacji jQuery MVC 4 dyskretny kod po stronie klienta.</span><span class="sxs-lookup"><span data-stu-id="c85a0-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="c85a0-495">Dyskretnego kodu jQuery używa prefiksu danych ajax JavaScript do wywołania metody akcji, na serwerze, a nie intrusively emitowanie wbudowanych skryptach klienta.</span><span class="sxs-lookup"><span data-stu-id="c85a0-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="c85a0-496">Zadanie 1. uruchomienie aplikacji przed włączeniem dyskretnego kodu jQuery</span><span class="sxs-lookup"><span data-stu-id="c85a0-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="c85a0-497">W tym zadaniu należy uruchomić aplikację przed dołączeniem jQuery, aby można było porównać oba modele sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="c85a0-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="c85a0-498">Otwórz **rozpocząć** rozwiązania znajdujący się w **źródło/Ex7-UnobtrusivejQueryValidation/rozpoczęcia/** folderu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="c85a0-499">W przeciwnym razie będziesz nadal korzystać z **zakończenia** rozwiązania uzyskać, wykonując poprzednim ćwiczeniu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="c85a0-500">Jeśli został otwarty dołączonym **rozpocząć** rozwiązania, należy pobrać niektóre brakujące pakiety NuGet przed kontynuowaniem.</span><span class="sxs-lookup"><span data-stu-id="c85a0-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="c85a0-501">Aby to zrobić, kliknij przycisk **projektu** menu, a następnie wybierz **Zarządzaj pakietami NuGet**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="c85a0-502">W **Zarządzaj pakietami NuGet** okno dialogowe, kliknij przycisk **przywrócić** Aby pobrać brakujące pakiety.</span><span class="sxs-lookup"><span data-stu-id="c85a0-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="c85a0-503">Na koniec Skompiluj rozwiązanie, klikając **kompilacji** | **Kompiluj rozwiązanie**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="c85a0-504">Jedną z zalet za pomocą narzędzia NuGet jest, że nie masz do wysłania wszystkie biblioteki w projekcie, zmniejszenie rozmiaru projektu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="c85a0-505">Za pomocą narzędzi NuGet Power Tools, określając wersji pakietu w pliku Packages.config można pobrać wymaganych bibliotek podczas pierwszego uruchomienia projektu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="c85a0-506">Jest to, dlaczego należy uruchomić następujące kroki, po otwarciu istniejącego rozwiązania, w tym środowisku laboratoryjnym.</span><span class="sxs-lookup"><span data-stu-id="c85a0-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="c85a0-507">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="c85a0-508">Data rozpoczęcia projektu na stronie głównej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-508">The project starts in the Home page.</span></span> <span data-ttu-id="c85a0-509">Przeglądaj **/StoreManager/tworzenie** i kliknij przycisk **Utwórz** bez wypełniania formularza, aby zweryfikować, że masz komunikatów dotyczących sprawdzania poprawności:</span><span class="sxs-lookup"><span data-stu-id="c85a0-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="c85a0-510">![Sprawdzanie poprawności klienta wyłączone](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "wyłączyć sprawdzanie poprawności klienta")</span><span class="sxs-lookup"><span data-stu-id="c85a0-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="c85a0-511">*Sprawdzanie poprawności klienta wyłączone*</span><span class="sxs-lookup"><span data-stu-id="c85a0-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="c85a0-512">W przeglądarce otwórz kod źródłowy HTML:</span><span class="sxs-lookup"><span data-stu-id="c85a0-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="c85a0-513">Zadanie 2 — Włączanie sprawdzania poprawności dyskretnego kodu klienta</span><span class="sxs-lookup"><span data-stu-id="c85a0-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="c85a0-514">W ramach tego zadania umożliwi jQuery **sprawdzania poprawności dyskretnego kodu klienta** z **Web.config** pliku, który jest domyślnie ustawiona na wartość false, we wszystkich nowych projektach programu ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="c85a0-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="c85a0-515">Ponadto dodasz, że niezbędne skrypty odwołania się jQuery pracy dyskretny kod weryfikacji klienta.</span><span class="sxs-lookup"><span data-stu-id="c85a0-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="c85a0-516">Otwórz **Web.Config** plików w katalogu głównym projektu i upewnij się, że **ClientValidationEnabled** i **UnobtrusiveJavaScriptEnabled** kluczy wartości są ustawione na **true**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="c85a0-517">Można także włączyć sprawdzanie poprawności klienta przez kod w Global.asax.cs, aby uzyskać te same wyniki:</span><span class="sxs-lookup"><span data-stu-id="c85a0-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="c85a0-518">**HtmlHelper.ClientValidationEnabled = true;**</span><span class="sxs-lookup"><span data-stu-id="c85a0-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="c85a0-519">Ponadto można przypisać atrybutu ClientValidationEnabled do dowolnego kontrolera, aby określić niestandardowe zachowanie.</span><span class="sxs-lookup"><span data-stu-id="c85a0-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="c85a0-520">Otwórz **Create.cshtml** na **Views\StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="c85a0-521">Upewnij się, że następujące pliki skryptów **jquery.validate** i **jquery.validate.unobtrusive**, do których istnieją odwołania w poprzez wyświetlanie &quot; **~/bundles/jqueryval** &quot; pakietu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view throught the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="c85a0-522">Te biblioteki jQuery są uwzględniane w nowych projektów MVC 4.</span><span class="sxs-lookup"><span data-stu-id="c85a0-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="c85a0-523">Można znaleźć więcej bibliotek w **/skrypty** folderu w projekcie.</span><span class="sxs-lookup"><span data-stu-id="c85a0-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="c85a0-524">Przed tym sprawdzania poprawności pracy bibliotek, musisz dodać odwołanie do biblioteki framework jQuery.</span><span class="sxs-lookup"><span data-stu-id="c85a0-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="c85a0-525">Ponieważ ta dokumentacja została już dodana w  **\_Layout.cshtml** pliku, nie trzeba go dodać w tego widoku.</span><span class="sxs-lookup"><span data-stu-id="c85a0-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="c85a0-526">Zadanie 3 — uruchamianie dyskretnego kodu za pomocą aplikacji jQuery sprawdzania poprawności</span><span class="sxs-lookup"><span data-stu-id="c85a0-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="c85a0-527">W tym zadaniu przetestujesz, **StoreManager** Tworzenie szablonu przeprowadza weryfikacji po stronie klienta przy użyciu biblioteki jQuery, gdy użytkownik tworzy nowy album widoku.</span><span class="sxs-lookup"><span data-stu-id="c85a0-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="c85a0-528">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="c85a0-529">Data rozpoczęcia projektu na stronie głównej.</span><span class="sxs-lookup"><span data-stu-id="c85a0-529">The project starts in the Home page.</span></span> <span data-ttu-id="c85a0-530">Przeglądaj **/StoreManager/tworzenie** i kliknij przycisk **Utwórz** bez wypełniania formularza, aby zweryfikować, że masz komunikatów dotyczących sprawdzania poprawności:</span><span class="sxs-lookup"><span data-stu-id="c85a0-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="c85a0-531">![Sprawdzanie poprawności klienta przy użyciu jQuery włączone](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "sprawdzanie poprawności klienta przy użyciu jQuery włączone")</span><span class="sxs-lookup"><span data-stu-id="c85a0-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="c85a0-532">*Sprawdzanie poprawności klienta przy użyciu jQuery włączone*</span><span class="sxs-lookup"><span data-stu-id="c85a0-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="c85a0-533">W przeglądarce otwórz kod źródłowy Utwórz widok:</span><span class="sxs-lookup"><span data-stu-id="c85a0-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="c85a0-534">Dla każdej reguły weryfikacji klienta jQuery dyskretny kod dodaje atrybut z danymi — val —*rulename*=&quot;*komunikat*&quot;.</span><span class="sxs-lookup"><span data-stu-id="c85a0-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="c85a0-535">Poniżej przedstawiono listę tagów tego Unobtrusive jQuery wstawia do pola wejściowego html, aby wykonać sprawdzanie poprawności klienta:</span><span class="sxs-lookup"><span data-stu-id="c85a0-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="c85a0-536">Val danych</span><span class="sxs-lookup"><span data-stu-id="c85a0-536">Data-val</span></span>
   > - <span data-ttu-id="c85a0-537">Dane val liczb</span><span class="sxs-lookup"><span data-stu-id="c85a0-537">Data-val-number</span></span>
   > - <span data-ttu-id="c85a0-538">Dane val zakresu</span><span class="sxs-lookup"><span data-stu-id="c85a0-538">Data-val-range</span></span>
   > - <span data-ttu-id="c85a0-539">Data-val zakres min / danych val — — maksimum zakresu</span><span class="sxs-lookup"><span data-stu-id="c85a0-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="c85a0-540">Wymagane val dane</span><span class="sxs-lookup"><span data-stu-id="c85a0-540">Data-val-required</span></span>
   > - <span data-ttu-id="c85a0-541">Dane o długości val</span><span class="sxs-lookup"><span data-stu-id="c85a0-541">Data-val-length</span></span>
   > - <span data-ttu-id="c85a0-542">Data-val długość max / danych val długość min</span><span class="sxs-lookup"><span data-stu-id="c85a0-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="c85a0-543">Wszystkie wartości danych są wypełniane przy użyciu modelu **adnotacji danych**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="c85a0-544">Następnie całą logikę, która działa na po stronie serwera może działać po stronie klienta.</span><span class="sxs-lookup"><span data-stu-id="c85a0-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="c85a0-545">Na przykład cena atrybut ma następujące adnotacji danych w modelu:</span><span class="sxs-lookup"><span data-stu-id="c85a0-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="c85a0-546">Po zakończeniu korzystania z dyskretnego kodu jQuery jest wygenerowany kod:</span><span class="sxs-lookup"><span data-stu-id="c85a0-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="c85a0-547">Podsumowanie</span><span class="sxs-lookup"><span data-stu-id="c85a0-547">Summary</span></span>

<span data-ttu-id="c85a0-548">Realizując ten warsztatów wiesz jak umożliwić użytkownikom zmienić dane przechowywane w bazie danych, korzystając z następujących czynności:</span><span class="sxs-lookup"><span data-stu-id="c85a0-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="c85a0-549">Indeks, tworzenia, edytowania, usuwania, takie jak akcji kontrolera</span><span class="sxs-lookup"><span data-stu-id="c85a0-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="c85a0-550">Funkcja tworzenia szkieletu ASP.NET MVC do wyświetlania właściwości tabeli HTML</span><span class="sxs-lookup"><span data-stu-id="c85a0-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="c85a0-551">Środowisko niestandardowych pomocników HTML w celu zwiększenia użytkownika</span><span class="sxs-lookup"><span data-stu-id="c85a0-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="c85a0-552">Metody akcji, które reagują na HTTP GET lub POST protokołu HTTP wywołania</span><span class="sxs-lookup"><span data-stu-id="c85a0-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="c85a0-553">Szablon udostępniony edytora podobne szablony widoku, takie jak tworzenie i edytowanie</span><span class="sxs-lookup"><span data-stu-id="c85a0-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="c85a0-554">Elementy formularza, takie jak listy rozwijane</span><span class="sxs-lookup"><span data-stu-id="c85a0-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="c85a0-555">Adnotacje danych na potrzeby weryfikacji modelu</span><span class="sxs-lookup"><span data-stu-id="c85a0-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="c85a0-556">Weryfikacja po stronie klienta przy użyciu dyskretnego kodu Biblioteka jQuery</span><span class="sxs-lookup"><span data-stu-id="c85a0-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="c85a0-557">Dodatek A: Installing Visual Studio Express 2012 for Web</span><span class="sxs-lookup"><span data-stu-id="c85a0-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="c85a0-558">Możesz zainstalować **programu Microsoft Visual Studio Express 2012 for Web** lub inne &quot;Express&quot; przy użyciu wersji **[Instalatora platformy sieci Web firmy Microsoft](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="c85a0-559">Poniższe wskazówki ułatwiają kroki wymagane do zainstalowania *programu Visual studio Express 2012 for Web* przy użyciu *Instalatora platformy sieci Web firmy Microsoft*.</span><span class="sxs-lookup"><span data-stu-id="c85a0-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="c85a0-560">Przejdź do [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="c85a0-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="c85a0-561">Alternatywnie, jeśli już zainstalowano Instalatora platformy sieci Web, możesz otworzyć go i Wyszukaj produkt &quot; <em>Visual Studio Express 2012 for Web z zestawem Windows Azure SDK</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="c85a0-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="c85a0-562">Kliknij pozycję **Zainstaluj teraz**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-562">Click on **Install Now**.</span></span> <span data-ttu-id="c85a0-563">Jeśli nie masz **Instalatora platformy sieci Web** nastąpi przekierowanie do pobrania i zainstalowania go najpierw.</span><span class="sxs-lookup"><span data-stu-id="c85a0-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="c85a0-564">Raz **Instalatora platformy sieci Web** jest otwarty, kliknij przycisk **zainstalować** można uruchomić Instalatora.</span><span class="sxs-lookup"><span data-stu-id="c85a0-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="c85a0-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="c85a0-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="c85a0-566">*Install Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="c85a0-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="c85a0-567">Odczytywanie wszystkich produktów licencji oraz warunki, a następnie kliknij przycisk **akceptuję** aby kontynuować.</span><span class="sxs-lookup"><span data-stu-id="c85a0-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Akceptowanie umowy licencyjnej](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="c85a0-569">*Akceptowanie umowy licencyjnej*</span><span class="sxs-lookup"><span data-stu-id="c85a0-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="c85a0-570">Zaczekaj, aż do zakończenia procesu pobierania i instalacji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-570">Wait until the downloading and installation process completes.</span></span>

    ![Postęp instalacji](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="c85a0-572">*Postęp instalacji*</span><span class="sxs-lookup"><span data-stu-id="c85a0-572">*Installation progress*</span></span>
6. <span data-ttu-id="c85a0-573">Po zakończeniu instalacji kliknij przycisk **Zakończ**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-573">When the installation completes, click **Finish**.</span></span>

    ![Instalacja została zakończona](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="c85a0-575">*Instalacja została zakończona*</span><span class="sxs-lookup"><span data-stu-id="c85a0-575">*Installation completed*</span></span>
7. <span data-ttu-id="c85a0-576">Kliknij przycisk **zakończenia** zamknąć Instalatora platformy sieci Web.</span><span class="sxs-lookup"><span data-stu-id="c85a0-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="c85a0-577">Aby otworzyć program Visual Studio Express for Web, przejdź do **Start** ekranu, a następnie zacznij pisać &quot; **VS Express**&quot;, następnie kliknij pozycję **VS Express for Web** Kafelek.</span><span class="sxs-lookup"><span data-stu-id="c85a0-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web tile](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="c85a0-579">*VS Express for Web tile*</span><span class="sxs-lookup"><span data-stu-id="c85a0-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="c85a0-580">Dodatek B: Za pomocą fragmentów kodu</span><span class="sxs-lookup"><span data-stu-id="c85a0-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="c85a0-581">Za pomocą wstawek kodu masz kod, czego potrzebujesz w zasięgu ręki.</span><span class="sxs-lookup"><span data-stu-id="c85a0-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="c85a0-582">Dokument laboratorium informuje o dokładnie podczas korzystania z nich, jak pokazano na poniższej ilustracji.</span><span class="sxs-lookup"><span data-stu-id="c85a0-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="c85a0-583">![Za pomocą wstawek kodu programu Visual Studio, aby wstawić kod do projektu](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "fragmenty kodu za pomocą programu Visual Studio, aby wstawić kod do projektu")</span><span class="sxs-lookup"><span data-stu-id="c85a0-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="c85a0-584">*Za pomocą wstawek kodu programu Visual Studio, aby wstawić kod do projektu*</span><span class="sxs-lookup"><span data-stu-id="c85a0-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="c85a0-585">***Aby dodać wstawki kodu za pomocą klawiatury (tylko język C#)***</span><span class="sxs-lookup"><span data-stu-id="c85a0-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="c85a0-586">Umieść kursor, w którym chcesz wstawić kod.</span><span class="sxs-lookup"><span data-stu-id="c85a0-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="c85a0-587">Rozpocznij wpisywanie nazwy fragmentu kodu (bez spacji i łączniki).</span><span class="sxs-lookup"><span data-stu-id="c85a0-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="c85a0-588">Obejrzyj, jak technologia IntelliSense wyświetla zgodne z nazwami fragmenty kodu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="c85a0-589">Wybierz prawidłowy fragment kodu lub pisz dalej do momentu wybrania debugowanej nazwy całego fragmentu kodu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="c85a0-590">Naciśnij klawisz Tab dwa razy, aby wstawić fragment kodu w lokalizacji kursora.</span><span class="sxs-lookup"><span data-stu-id="c85a0-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="c85a0-591">![Rozpocznij wpisywanie nazwy fragmentu kodu](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Rozpocznij wpisywanie nazwy fragmentu kodu")</span><span class="sxs-lookup"><span data-stu-id="c85a0-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="c85a0-592">*Rozpocznij wpisywanie nazwy fragmentu kodu*</span><span class="sxs-lookup"><span data-stu-id="c85a0-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="c85a0-593">![Naciśnij klawisz Tab, aby zaznaczyć fragment wyróżnione](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "naciśnij klawisz Tab, aby wybrać wyróżnione fragmentu kodu")</span><span class="sxs-lookup"><span data-stu-id="c85a0-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="c85a0-594">*Naciśnij klawisz Tab, aby wybrać wyróżnione fragment kodu*</span><span class="sxs-lookup"><span data-stu-id="c85a0-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="c85a0-595">![Ponownie naciśnij klawisz Tab i fragment kodu zostanie rozwinięte](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "rozwinie ponownie naciśnij klawisz Tab i fragment kodu")</span><span class="sxs-lookup"><span data-stu-id="c85a0-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="c85a0-596">*Ponownie naciśnij klawisz Tab i fragment kodu zostanie rozwinięte.*</span><span class="sxs-lookup"><span data-stu-id="c85a0-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="c85a0-597">***Aby dodać wstawki kodu za pomocą myszy (C#, Visual Basic i XML)*** 1.</span><span class="sxs-lookup"><span data-stu-id="c85a0-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="c85a0-598">Kliknij prawym przyciskiem myszy, gdy chcesz wstawić fragment kodu.</span><span class="sxs-lookup"><span data-stu-id="c85a0-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="c85a0-599">Wybierz **Wstaw fragment kodu** następuje **Moje fragmenty kodu**.</span><span class="sxs-lookup"><span data-stu-id="c85a0-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="c85a0-600">Wybierz odpowiedni fragment z listy, klikając go.</span><span class="sxs-lookup"><span data-stu-id="c85a0-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="c85a0-601">![Kliknij prawym przyciskiem myszy, które chcesz wstawić fragment kodu i wybierz opcję Wstaw fragment kodu](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "kliknij prawym przyciskiem myszy, które chcesz wstawić fragment kodu i wybierz opcję Wstaw fragment kodu")</span><span class="sxs-lookup"><span data-stu-id="c85a0-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="c85a0-602">*Kliknij prawym przyciskiem myszy, które chcesz wstawić fragment kodu i wybierz opcję Wstaw fragment kodu*</span><span class="sxs-lookup"><span data-stu-id="c85a0-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="c85a0-603">![Wybierz odpowiedni fragment z listy, klikając go](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "wybierz odpowiedni fragment z listy, klikając go")</span><span class="sxs-lookup"><span data-stu-id="c85a0-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="c85a0-604">*Wybierz odpowiedni fragment z listy, klikając go*</span><span class="sxs-lookup"><span data-stu-id="c85a0-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
