...
3. Upewnij się, że następujące pliki skryptów **jquery.validate** i **jquery.validate.unobtrusive**, do których istnieją odwołania w poprzez wyświetlanie &quot; **~/bundles/jqueryval** &quot; pakietu.
