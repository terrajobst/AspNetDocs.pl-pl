...
Używasz ograniczników skryptów &lt;% i%&gt; do oznaczania początku i końca skryptu. Ten skrypt jest pisany w języku Visual Basic. Wyświetla bieżącą datę i godzinę, wywołując metodę Response. Write () w celu renderowania zawartości w przeglądarce. Ograniczniki skryptu &lt;% i%&gt; mogą służyć do wykonywania jednej lub kilku instrukcji.
...
Aby wygenerować zawartość dynamiczną w widoku, można użyć dowolnego języka platformy .NET. Zwykle używa się Visual Basic .NET lub C# do pisania kontrolerów i widoków.
...
**Ilustracja 01**: standardowy formularz logowania ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](asp-net-mvc-views-overview-vb/_static/image2.png))
...
(Ponieważ został utworzony komunikat wypróbujemy w ProductController, my chcemy zakodować komunikat. Jednak dobrym wykonywaćem jest zawsze wywoływanie metody html. Encode () podczas wyświetlania zawartości pobranej z widoku danych w widoku.
