...
**Ilustracja 01**: jednostka filmu ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](validating-with-the-idataerrorinfo-interface-vb/_static/image2.png))
...
Klasa filmu jest generowana przez Entity Framework. Kod dla klasy filmów można zobaczyć, jeśli rozwiniesz plik MoviesDBModel. edmx w oknie Eksplorator rozwiązań i otworzysz plik MoviesDBModel. Designer. vb w edytorze kodu (patrz rysunek 2).
...
**Ilustracja 02**. kod dla jednostki filmu ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](validating-with-the-idataerrorinfo-interface-vb/_static/image4.png))
...
[![tworzenia metod akcji automatycznie](validating-with-the-idataerrorinfo-interface-vb/_static/image3.jpg)](validating-with-the-idataerrorinfo-interface-vb/_static/image5.png)

**Ilustracja 03**: formularz z brakującymi wartościami ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](validating-with-the-idataerrorinfo-interface-vb/_static/image6.png))
