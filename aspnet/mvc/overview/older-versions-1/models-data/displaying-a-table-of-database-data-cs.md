...
[Pobierz plik PDF](https://download.microsoft.com/download/1/1/f/11f721aa-d749-4ed7-bb89-a681b68894e6/ASPNET_MVC_Tutorial_11_CS.pdf)
...
[![tworzenia klas LINQ to SQL](displaying-a-table-of-database-data-cs/_static/image1.jpg)](displaying-a-table-of-database-data-cs/_static/image1.png)

**Ilustracja 01**. tworzenie klas LINQ to SQL ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](displaying-a-table-of-database-data-cs/_static/image2.png))
...
[![projektanta Entity Data Model](displaying-a-table-of-database-data-cs/_static/image2.jpg)](displaying-a-table-of-database-data-cs/_static/image3.png)

**Ilustracja 02**: Projektant Entity Data Model ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](displaying-a-table-of-database-data-cs/_static/image4.png))
...
[![menu Dodaj kontroler](displaying-a-table-of-database-data-cs/_static/image3.jpg)](displaying-a-table-of-database-data-cs/_static/image5.png)

**Ilustracja 03**: menu Dodaj kontroler ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](displaying-a-table-of-database-data-cs/_static/image6.png))
...
[![oknie dialogowym Dodawanie kontrolera](displaying-a-table-of-database-data-cs/_static/image4.jpg)](displaying-a-table-of-database-data-cs/_static/image7.png)

**Ilustracja 04**: okno dialogowe Dodawanie kontrolera ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](displaying-a-table-of-database-data-cs/_static/image8.png))
...
Na liście 1 Klasa MoviesDBEntities jest używana do reprezentowania bazy danych MoviesDB. Aby użyć tej klasy, należy zaimportować przestrzeń nazw MvcApplication1. models w następujący sposób:

Korzystanie z MvcApplication1. models;

Jednostki wyrażenia *. MovieSet. ToList — ()* zwraca zestaw wszystkich filmów z tabeli bazy danych filmów.
...
**Ilustracja 05**. Dodawanie widoku ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](displaying-a-table-of-database-data-cs/_static/image10.png))
...
[![oknie dialogowym Dodawanie widoku](displaying-a-table-of-database-data-cs/_static/image6.jpg)](displaying-a-table-of-database-data-cs/_static/image11.png)

**Ilustracja 06**. okno dialogowe Dodawanie widoku ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](displaying-a-table-of-database-data-cs/_static/image12.png))
...
[![tabeli filmów](displaying-a-table-of-database-data-cs/_static/image7.jpg)](displaying-a-table-of-database-data-cs/_static/image13.png)

**Ilustracja 07**: tabela filmów ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](displaying-a-table-of-database-data-cs/_static/image14.png))
...
Widok w liście 4 zawiera pętlę Foreach, która iteruje przez wszystkie filmy. Dla każdego filmu MovieTemplate częściowa służy do formatowania filmu. MovieTemplate jest renderowany przez wywołanie metody pomocnika RenderPartial ().
