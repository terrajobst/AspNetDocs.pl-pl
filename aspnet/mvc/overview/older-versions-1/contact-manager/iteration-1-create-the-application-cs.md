...
title: 'Iteracja #1 — Tworzenie aplikacji (C#) | Microsoft Docs'
author: microsoft
...
**Ilustracja 01**. okno dialogowe Nowy projekt ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image2.png))
...
**Ilustracja 02**. okno dialogowe Tworzenie projektu testu jednostkowego ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image4.png))
...
**Ilustracja 03**: okno Eksplorator rozwiązań ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image6.png))
...
**Rysunek 04**: Tworzenie nowej bazy danych Microsoft SQL Server Express ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image8.png))
...
**Ilustracja 05**: Projektant tabel bazy danych ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image10.png))
...
**Ilustracja 06**. okno dialogowe Dodaj nowy element ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image12.png))
...
**Ilustracja 07**. Wybierz zawartość modelu ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image14.png))
...
**Ilustracja 08**: Wybieranie połączenia danych ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image16.png))
...
**Ilustracja 09**. Wybierz obiekty bazy danych ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image18.png))
...
**Ilustracja 10**. Klasa Contact ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image20.png))
...
**Ilustracja 11**. Dodawanie kontrolera macierzystego ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image22.png))
...
**Ilustracja 12**. Dodawanie widoku indeksu ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image24.png))

W oknie dialogowym **Dodawanie widoku** zaznacz pole wyboru z etykietą **Utwórz widok o jednoznacznie określonym typie**. Wybierz pozycję Wyświetl klasę danych ContactManager. models. Contact i Wyświetl listę zawartości. Wybranie tych opcji spowoduje wygenerowanie widoku zawierającego listę rekordów kontaktów.
...
**Ilustracja 13**. okno dialogowe Dodawanie widoku ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image26.png))
...
**Ilustracja 14**. Włączanie debugowania ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image28.png))
...
**Ilustracja 15**. widok indeksu ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image30.png))
...
**Lista 4-Controllers\HomeController.cs (z metodami Create)**
...
**Ilustracja 16**. Dodawanie widoku ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image32.png))

W oknie dialogowym **Dodawanie widoku** wybierz klasę **ContactManager. models. Contact** i opcję **Utwórz** dla zawartości widoku (Zobacz Rysunek 17). Po kliknięciu przycisku **Dodaj** zostanie automatycznie wygenerowany widok tworzenie.
...
**Ilustracja 17**. Wyświetlanie rozwinięcia strony ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image34.png))
...
**Ilustracja 18**. widok tworzenia ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image36.png))
...
**Lista 6-Controllers\HomeController.cs (z metodami edycji)**
...
**Ilustracja 19**. Dodawanie widoku edycji ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image38.png))
...
**Lista 8-Controllers\HomeController.cs (usuwanie metod)**
...
**Ilustracja 20**. widok potwierdzenia usunięcia ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image40.png))
...
**Ilustracja 21**. widok indeksu z linkiem edycji ([kliknij, aby wyświetlić obraz o pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image42.png))
...
**Ilustracja 22**: Dodawanie widoku potwierdzenia usuwania ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image44.png))
...
**Ilustracja 23**. Refaktoryzacja nazwy kontrolera ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image46.png))
...
**Ilustracja 24**. Korzystanie z okna dialogowego zmiany nazwy ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image48.png))
...
**Ilustracja 25**: Brak domyślnego kontrolera ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-1-create-the-application-cs/_static/image50.png))
