...
[Pobierz kod](iteration-5-create-unit-tests-cs/_static/contactmanager_5_cs1.zip)
...
4. Dodaj odwołanie do zestawu MOQ, klikając prawym przyciskiem myszy folder References w projekcie ContactManager. Tests i wybierając pozycję **Dodaj odwołanie**. Na karcie przeglądanie przejdź do folderu, w którym został rozpakowany MOQ, a następnie wybierz zestaw MOQ. dll. Kliknij przycisk **OK**.
5. Po wykonaniu tych kroków folder odwołań powinien wyglądać jak rysunek 2.
...
**Ilustracja 01**. Odblokowywanie MOQ ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-5-create-unit-tests-cs/_static/image2.png))
...
**Ilustracja 02**: odwołania po dodaniu MOQ ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-5-create-unit-tests-cs/_static/image4.png))
...
Utwórz nowy folder o nazwie models w projekcie ContactManager. tests. Następnie kliknij prawym przyciskiem myszy folder modele i wybierz polecenie **Dodaj, nowy test**. Zostanie wyświetlone okno dialogowe **Dodawanie nowego testu** pokazane na rysunku 3. Wybierz szablon **testu jednostkowego** i nazwij nowy test ContactManagerServiceTest.cs. Kliknij przycisk **OK** , aby dodać nowy test do projektu testowego.
...
**Ilustracja 03**: Models\ContactManagerServiceTest.cs ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-5-create-unit-tests-cs/_static/image6.png))
...
[![Wyniki testów](iteration-5-create-unit-tests-cs/_static/image4.jpg)](iteration-5-create-unit-tests-cs/_static/image7.png)

**Ilustracja 04**: wyniki testów ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-5-create-unit-tests-cs/_static/image8.png))

## <a name="creating-unit-tests-for-controllers"></a>Tworzenie testów jednostkowych dla kontrolerów

Aplikacja ASP. NETMVC steruje przepływem interakcji użytkownika. Podczas testowania kontrolera, należy sprawdzić, czy kontroler zwróci odpowiednie wyniki akcji i wyświetli dane. Warto również sprawdzić, czy kontroler współdziała z klasami modelu w oczekiwany sposób.
